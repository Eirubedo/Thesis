...
const translations = {
  en: {
    ...
    "emergency.whatsappMentalHealth": "WhatsApp Mental Health Facility",
    "emergency.nearbyFacilities": "Nearby Healthcare Facilities",
    "emergency.facilitiesDescription": "Find healthcare facilities near your location.",
    "emergency.findingFacilities": "Finding nearby facilities...",
    "emergency.noFacilitiesFound": "No facilities found nearby",
    "emergency.findNearby": "Find Nearby",
    "emergency.call": "Call",
    "emergency.directions": "Directions",
    "emergency.resources": "Resources",
    "emergency.resourcesDescription": "Additional mental health resources and information.",
    "emergency.nationalSuicidePrevention": "National Suicide Prevention Lifeline",
    "emergency.crisisTextLine": "Crisis Text Line: Text HOME to 741741",
    "emergency.emergencyServices": "Emergency Services: 911",
    "emergency.mentalHealthHotline": "Mental Health Hotline: 1-800-662-4357",
    "emergency.reminder": "Remember: You are not alone. Help is available 24/7.",
    "emergency.locationNotSupported": "Location services are not supported by this browser.",
    "emergency.generalHospital": "General Hospital",
    "emergency.generalHospitalAddress": "Main Street, City Center",
    "emergency.generalClinicAddress": "Clinic Street, Downtown",
    "emergency.emergencyCenter": "Emergency Medical Center",
    "emergency.emergencyCenterAddress": "Emergency Ave, Downtown",
    ...
    "monitoring.currentMedications": "Current Medications",
    "monitoring.currentMedicationsDesc": "Manage your medication list",
    "monitoring.schedule": "Schedule",
    "monitoring.actions": "Actions",
    "monitoring.deleteMedication": "Delete Medication",
    "monitoring.deleteMedicationConfirm": "Are you sure you want to delete",
    "monitoring.delete": "Delete",
    "monitoring.noCurrentMedications": "No medications added yet",
    "monitoring.noCurrentMedicationsDesc": "Add your first medication to start tracking",
    "monitoring.activeMedications": "active medications",
  ...
  id: {
    ...
    // Emergency Support
    "emergency.title": "Dukungan Darurat",
    "emergency.crisisSupport": "Dukungan Krisis",
    "emergency.crisisDescription":
      "Jika Anda dalam bahaya langsung atau memiliki pikiran untuk menyakiti diri sendiri, segera minta bantuan.",
    ...
    "emergency.whatsappMentalHealth": "WhatsApp Fasilitas Kesehatan Mental",
    "emergency.nearbyFacilities": "Fasilitas Kesehatan Terdekat",
    "emergency.facilitiesDescription": "Temukan fasilitas kesehatan di dekat lokasi Anda.",
    "emergency.findingFacilities": "Mencari fasilitas terdekat...",
    "emergency.noFacilitiesFound": "Tidak ada fasilitas ditemukan di sekitar",
    "emergency.findNearby": "Cari Terdekat",
    "emergency.call": "Telepon",
    "emergency.directions": "Petunjuk Arah",
    "emergency.resources": "Sumber Daya",
    "emergency.resourcesDescription": "Sumber daya kesehatan mental tambahan dan informasi.",
    "emergency.nationalSuicidePrevention": "Hotline Pencegahan Bunuh Diri Nasional",
    "emergency.crisisTextLine": "Crisis Text Line: Kirim SMS HOME ke 741741",
    "emergency.emergencyServices": "Layanan Darurat: 119",
    "emergency.mentalHealthHotline": "Hotline Kesehatan Mental: 1-800-662-4357",
    "emergency.reminder": "Ingat: Anda tidak sendirian. Bantuan tersedia 24/7.",
    "emergency.locationNotSupported": "Layanan lokasi tidak didukung oleh browser ini.",
    "emergency.generalHospital": "Rumah Sakit Umum",
    "emergency.generalHospitalAddress": "Jalan Utama, Pusat Kota",
    "emergency.generalClinicAddress": "Jalan Klinik, Pusat Kota",
    "emergency.emergencyCenter": "Pusat Medis Darurat",
    "emergency.emergencyCenterAddress": "Jalan Darurat, Pusat Kota",
    ...
    "monitoring.days": "hari",
    "monitoring.currentMedications": "Obat Saat Ini",
    "monitoring.currentMedicationsDesc": "Kelola daftar obat Anda",
    "monitoring.schedule": "Jadwal",
    "monitoring.actions": "Tindakan",
    "monitoring.deleteMedication": "Hapus Obat",
    "monitoring.deleteMedicationConfirm": "Apakah Anda yakin ingin menghapus",
    "monitoring.delete": "Hapus",
    "monitoring.noCurrentMedications": "Belum ada obat yang ditambahkan",
    "monitoring.noCurrentMedicationsDesc": "Tambahkan obat pertama Anda untuk mulai melacak",
    "monitoring.activeMedications": "obat aktif",
