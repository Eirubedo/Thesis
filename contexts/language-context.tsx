...
const translations = {
  en: {
    ...
    "monitoring.onceDailyFreq": "Once daily",
    "monitoring.twiceDailyFreq": "Twice daily",
    "monitoring.threeTimesDailyFreq": "Three times daily",
    "monitoring.asNeededFreq": "As needed",
    "monitoring.day": "day",
    "monitoring.week": "week",
    "monitoring.month": "month",
    "monitoring.days": "days",
    "monitoring.weeks": "weeks",
    "monitoring.months": "months",
    "monitoring.lifelong": "Lifelong",
    "monitoring.duration": "Duration",
    "monitoring.selectDuration": "Select duration",
    "monitoring.durationValue": "Duration Value",
    "monitoring.enter": "Enter",
    "monitoring.numberOfDays": "number of days",
    "monitoring.numberOfWeeks": "number of weeks",
    "monitoring.numberOfMonths": "number of months",
    "monitoring.daysLeft": "days left",
  ...
  id: {
    ...
    "monitoring.onceDailyFreq": "Sekali sehari",
    "monitoring.twiceDailyFreq": "Dua kali sehari",
    "monitoring.threeTimesDailyFreq": "Tiga kali sehari",
    "monitoring.asNeededFreq": "Sesuai kebutuhan",
    "monitoring.day": "hari",
    "monitoring.week": "minggu",
    "monitoring.month": "bulan",
    "monitoring.days": "hari",
    "monitoring.weeks": "minggu",
    "monitoring.months": "bulan",
    "monitoring.lifelong": "Seumur hidup",
    "monitoring.duration": "Durasi",
    "monitoring.selectDuration": "Pilih durasi",
    "monitoring.durationValue": "Nilai Durasi",
    "monitoring.enter": "Masukkan",
    "monitoring.numberOfDays": "jumlah hari",
    "monitoring.numberOfWeeks": "jumlah minggu",
    "monitoring.numberOfMonths": "jumlah bulan",
    "monitoring.daysLeft": "hari tersisa",
