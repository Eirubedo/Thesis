...
const translations = {
  en: {
    ...
    "login.enterCredentials": "Enter your phone number and password to access your account",
    "login.or": "Or",
  ...
  id: {
    ...
    "login.enterCredentials": "Masukkan nomor telepon dan kata sandi Anda untuk mengakses akun",
    "login.or": "Atau",
